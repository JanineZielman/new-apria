import { GQtyError, SelectionType, doRetry } from 'gqty';
import * as React from 'react';
import { useLazyRef, useIsomorphicLayoutEffect } from '../common.mjs';
      ...
      async (refetchArg) => {
        if (refetchArg !== void 0) {
          ...
          try {
            ...
            const error = GQtyError.create(err, useRefetch2);
            dispatch({
              type: "error",
              error
            });
