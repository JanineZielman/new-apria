...
import { useDeferDispatch, useSuspensePromise, fetchPolicyDefaultResolveOptions } from '../common.mjs';
    ...
    const queryFn = React.useCallback(
      function callback(callbackArgs = {}) {
        ...
        return resolved(functionResolve, {
          ...
          (err) => {
            var _a3, _b2;
            const error = GQtyError.create(err, useLazyQuery2);
