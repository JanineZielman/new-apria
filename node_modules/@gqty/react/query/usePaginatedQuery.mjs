...
import { useSelectionsState, useSuspensePromise, useSubscribeCacheChanges, uniqBy, sortBy, coreHelpers } from '../common.mjs';
...
function createUsePaginatedQuery({
  ...
  function usePaginatedQuery(fn, opts) {
    ...
    const fetchMore = React.useCallback(
      (newArgs, fetchPolicy = optsRef.current.fetchPolicy || defaultFetchPolicy) => {
