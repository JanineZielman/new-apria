...
import { useSuspensePromise, useDeferDispatch } from '../common.mjs';
    ...
    const callRefetchQueries = React.useCallback(() => {
      ...
      if (refetchQueries == null ? void 0 : refetchQueries.length) {
        const refetchPromise = Promise.all(
          ...
          dispatch({
            type: "failure",
            error: GQtyError.create(err, useMutation2)
          });
        });
    ...
    const mutate = React.useCallback(
      function mutateFn({
        ...
        return resolved(functionResolve, {
          ...
          (err) => {
            var _a2, _b2;
            const error = GQtyError.create(err, useMutation2);
