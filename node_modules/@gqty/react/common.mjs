import { Selection, prepass, getFields, getArrayFields, selectFields, castNotSkeleton, castNotSkeletonDeep } from 'gqty';
...
function useInterceptSelections({
  ...
  const cacheRefetchSelections = enabledStaleWhileRevalidate ? /* @__PURE__ */ new Set() : null;
...
export { IS_BROWSER, coreHelpers, fetchPolicyDefaultResolveOptions, isAnySelectionIncluded, isAnySelectionIncludedInMatrix, isSelectionIncluded, sortBy, toSetIfNeeded, uniqBy, useBuildSelections, useDeferDispatch, useForceUpdate, useInterceptSelections, useIsMounted, useIsRendering, useIsWindowVisible, useIsomorphicLayoutEffect, useLazyRef, useOnFirstMount, useSelectionsState, useSubscribeCacheChanges, useSuspensePromise, useUpdateEffect };
